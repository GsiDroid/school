...
/**
 * Add New Expense
 * Form to create a new expense record
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if (empty($reference_no)) {
            $reference_no = 'EXP-' . date('Ymd') . '-' . rand(1000, 9999);
        }
        
        // Insert expense record
        $stmt = $conn->prepare("INSERT INTO expenses 
                              (title, amount, category_id, expense_date, payment_method, reference_no, description, status, created_by, created_at) 
                              VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())");
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="amount" name="amount" step="0.01" min="0.01" value="<?php echo isset($_POST['amount']) ? htmlspecialchars($_POST['amount']) : ''; ?>" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="payment_method" name="payment_method" required>
                                ...
                                <option value="Mobile Payment" <?php echo (isset($_POST['payment_method']) && $_POST['payment_method'] == 'Mobile Payment') ? 'selected' : ''; ?>>Mobile Payment</option>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="reference_no" name="reference_no" value="<?php echo isset($_POST['reference_no']) ? htmlspecialchars($_POST['reference_no']) : ''; ?>" placeholder="Auto-generated if left blank">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="form-text">Supported formats: JPG, PNG, PDF. Max size: 2MB</div>
                        </div>
                    </div>
                </div>
